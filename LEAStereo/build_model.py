...
from LEAStereo.build_model_2d import AutoFeature, Disp
from LEAStereo.build_model_3d import AutoMatching
import pdb
from time import time

class AutoStereo(nn.Module):
    def __init__(self, maxdisp=192, Fea_Layers=6, Fea_Filter=8, Fea_Block=4, Fea_Step=3, Mat_Layers=12, Mat_Filter=8, Mat_Block=4, Mat_Step=3, device='cpu'):
        ...
        self.disp = Disp(self.maxdisp, self.device)
