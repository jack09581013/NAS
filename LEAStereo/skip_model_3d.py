...
import numpy as np
from LEAStereo.genotypes_3d import PRIMITIVES
from LEAStereo.genotypes_3d import Genotype
from LEAStereo.operations_3d import *
...
class newMatching(nn.Module):
    def __init__(self, network_arch, cell_arch, cell=Cell, config=None):
        ...
        self._step = config.mat_step
        self._num_layers = config.mat_num_layers
        self._block_multiplier = config.mat_block_multiplier
        self._filter_multiplier = config.mat_filter_multiplier
