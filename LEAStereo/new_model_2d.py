...
from LEAStereo.genotypes_2d import Genotype
...
class newFeature(nn.Module):
    def __init__(self, network_arch, cell_arch, cell=Cell, config=None):
        ...
        self._step = config.fea_step
        self._num_layers = config.fea_num_layers
        self._block_multiplier = config.fea_block_multiplier
        self._filter_multiplier = config.fea_filter_multiplier
