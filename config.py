...
class Config_Search(Config_Flyingthings3D):
    def __init__(self):
        ...
        self.save_best_model_path = './models/best_AutoStereo.pth'
...
class Config_Decode(Config_Flyingthings3D):
    def __init__(self):
        ...
        # decode
        self.resume = './models/best_AutoStereo.pth'
        self.step = 3
...
class Config_Train(Config_Flyingthings3D):
    def __init__(self):
        ...
        # train
        self.resume = './models/best_LEAStereo.pth'
        self.net_arch_fea = './models/feature_network_path.npy'
        self.cell_arch_fea = './models/feature_genotype.npy'
        self.net_arch_mat = './models/matching_network_path.npy'
        self.cell_arch_mat = './models/matching_genotype.npy'

        self.save_history_file_path = './images/history_LEAStereo.png'
        self.save_best_model_path = './models/best_LEAStereo.pth'
